...
Version:        3.1.1
Release:        2%{?dist}
Summary:        Cross-platform music player with word-by-word lyrics
...
%description
SPlayer is a minimal cross-platform music player with word-by-word
and desktop lyrics, Jellyfin/Navidrome/Emby media server support,
cloud music drive, local library management and audio spectrum
visualization.
...
[Desktop Entry]
Name=Splayer
Comment=Cross-platform music player with word-by-word lyrics
Exec=%{name}
Icon=%{name}
Terminal=false
Type=Application
...
%changelog
* Tue Sep 22 2026 Maomaokuxs <biyuanh@qq.com> - 3.1.1-2
